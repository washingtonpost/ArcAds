...
* wrapper.
* @param {string} id - A string containing the advertisement id corresponding to the div the
* advertisement will load into.
* @param {string} slotName - A string containing the slot name of the advertisement, for instance
* '1234/adn.com/homepage'.
...
export function fetchAmazonBids(id, slotName, dimensions, breakpoints, cb = null) {
  ...
  if (breakpoints && typeof window.innerWidth !== 'undefined' && dimensions[0][0][0] !== undefined) {
    ...
    for (let ind = 0; ind < breakpointsLength; ind += 1) {

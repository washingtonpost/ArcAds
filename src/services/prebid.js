...
/**
 * @desc Calls the Prebid request method for fetching bids, once fetched the advertisement is
 * refreshed unless a callback is defined.
 * @param {object} ad - An object containing the GPT ad slot.
 * @param {string} code - A string containing the advertisement id or slotname corresponding to
 * the div the advertisement will load into.
 * @param {number} timeout - An integer communicating how long in ms the Prebid.js service should
 * wait before it closes the auction for a lot.
 * @param {object} info - An object containing information about the advertisement that is about
 * to load.
 * @param {function} prerender - An optional function that will run before the advertisement
 * renders.
 * @param {function} cb - An optional callback function that should fire whenever the bidding has
 * concluded.
 * */
 ...
 * @param {object} bids - Contains all of the applicable bid data, such as which vendors to use
 * and their placement ids.

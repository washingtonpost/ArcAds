/**
* @desc If a different key is required to serve position targeting for older creatives, rename it
* here.
...
* @return - Returns the targeting object with the old position value stripped out, and the new one
* with the desired key in its place.
* */
export default function renamePositionKey(targeting, positionValue) {
